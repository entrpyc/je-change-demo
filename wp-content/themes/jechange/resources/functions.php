...
function my_acf_admin_head() {
    ...
    <style type="text/css">
        ...
        .imagePreview img { width:460px; height:auto; display:block; }
            ...
            $('a[data-name=add-layout]').click(function(){
                waitForEl('.acf-tooltip li', function() {
                    $('.acf-tooltip li a').hover(function(){
                        ...
                        $('.acf-tooltip').append('<div class="imagePreview"><img src="<?php echo $siteURL; ?>/wp-content/themes/jechange/modules/images/' + imageTP + '.png"></div>');
                    }, function(){
                        $('.imagePreview').remove();
                    });
                });
